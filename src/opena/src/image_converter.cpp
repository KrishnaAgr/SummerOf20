...
//     }
      ...
      int main(int argc, char** argv)
    {
      ...
      // ImageConverter ic;
        ros::NodeHandle nh_;
        ros::Subscriber image_sub = nh_.subscribe("/magnus/camera/image_raw_mouse_left", 1, imageCb);
      ...
      while(ros::ok()) {
        ...
        for(int i=0; i<contours.size(); ++i)
        {
            ...
            ros::Publisher centre_pub = nh_.advertise<opena::Centre>("detector/centre", 1);
